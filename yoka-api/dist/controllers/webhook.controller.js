...
exports.omiseWebhookController = void 0;
const prisma_1 = __importDefault(require("../config/prisma"));
const http_status_codes_1 = require("http-status-codes");
const omiseWebhookController = async (req, res) => {
    try {
        ...
        res.status(http_status_codes_1.StatusCodes.OK).send("Webhook received");
    }
    catch (error) {
...
exports.omiseWebhookController = omiseWebhookController;
